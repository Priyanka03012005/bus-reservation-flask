...
@app.route('/')
def home():
    return render_template('userlogin.html') # admin site
@app.route('/admin')
def admin():
    return render_template('admin.html') # Creating new database
@app.route('/bus.html')
def new_student():
    ...
    conn.close()
    return render_template('find.html')# Adding new bus record
...
def addrec():
    if request.method == 'POST':
        try:
            ...
            con.close() # renders template to delete a bus record
@app.route('/delete.html')
def deleterecord():
    return render_template('delete.html')# delete the record
...
@app.route('/find.html')
def findrecord():
    return render_template('find.html') # find the record
...
def findbus():
    ...
    if (rows):
        ...
        return render_template("result.html", msg=msg) # list all records
@app.route('/list.html')
def list():
    ...
    return render_template("list.html", rows=rows, msg=msg, user=username) # list all buses booked by user
